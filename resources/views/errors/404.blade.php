...
<head>
  ...
  <title>Pages / Page not found 404 - FMIS</title>
  ...
  <main>
    <div class="container">
      ...
      <section class="section error-404 min-vh-100 d-flex flex-column align-items-center justify-content-center">
        ...
        <a href="{{ url()->previous() }}" class="btn" href="index.html">
            <i class="bi bi-arrow-left"></i>
            Go Back
          </a>
        <img src="{{ asset('assets/layouts/img/not-found.svg') }}" class="img-fluid py-5" alt="Forbidden">
      </section>
