                    ...
                    <div class="flex-grow-1">
                        ...
                        <div class="mt-3 mt-md-0">
                            <a href="#addFundSourceModal"
                                ...
                                <i class="bi bi-plus-circle"></i> <span class="text-bg">Create New Fund Source</span>
                            </a>
                        </div>
                      ...
                      <table id="example" class="table text-nowrap table-centered mt-0" style="width: 100%">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>{{ $fundSource->category?->name }}</td>
                            <td>
                                <!-- Edit Button -->
            ...
            <form action="{{ route('fund-sources.update', $fundSource->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="category_id" id="edit-category-id" value="{{ $fundSource->category?->name }}">
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @if ($fundSource->category->id == $category->id) selected @endif>{{ $category?->name }}</option>
                            @endforeach
                        </select>
                    </div>
...
<div class="modal fade" id="deleteFundSourceModal-{{$fundSource->id}}" tabindex="-1"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="deleteFundSourceModalLabel">Confirmation</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
