...
<div class="modal fade" id="addAllotmentClassModal" tabindex="-1" aria-labelledby="addAllotmentClassModalLabel" aria-hidden="true">
            ...
            <form action="{{ route('allotment-classes.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="abbrev" name="abbrev" placeholder="Enter abbreviation" required>
                    </div>
                    <div class="mb-3">
...
@foreach ($allotmentClasses as $allotmentClass)
<div class="modal fade" id="editAllotmentClassModal-{{ $allotmentClass->id }}" tabindex="-1" aria-labelledby="editAllotmentClassModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('allotment-classes.update', $allotmentClass->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label for="name" class="form-label">Name:</label>
                        <input type="text" class="form-control" id="name" name="name" value="{{ $allotmentClass->name }}" required>
                    </div>
                </div>
                <div class="modal-footer">
...
@foreach ($allotmentClasses as $allotmentClass)
<div class="modal fade" id="deleteAllotmentClassModal-{{ $allotmentClass->id }}" tabindex="-1" aria-labelledby="deleteAllotmentClassModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('allotment-classes.delete', $allotmentClass->id) }}" method="POST">
                ...
                <div class="modal-body">
                    Are you sure you want to delete Allotment Class: <strong>{{ $allotmentClass->name }}</strong>?
                </div>
                <div class="modal-footer">
